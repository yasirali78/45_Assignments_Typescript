...
// Completed all Installations
    ...
    let  famousQuote1: 
        string = "Albert Einstein once said, A person who never made a mistake never tried anything new"
    ...
    let message = `My favourite Number is ${favouriteNumber} ,`;
       ...
       //     Assingnment #10
        ...
        const Names :string[]= ["Azhar","Abbas","Hammad","Asghar"]
        console.log(Names[3]);
    
        const names1:string[]= ["Azhar","Abbas","Hammad","Asghar"];
    ...
    //        Assignment #11
        ...
        const Names2 :string[]= ["Azhar","Abbas","Hammad","Asghar"]
...
//         Guest list Dinner invitation 
   let Guestlists:string[]= ["Shahid","Zakir","Ayaz"];
   for (const Guestlist of Guestlists ) {
        ...
        // Original guest list
        let guestList2: string[] = ["Shahid", "Zakir", "Ayaz"];
        ...
        const newPerson2: string = "Danish";
...
//            ASSIGNMENT #16
    ...
    // Original guest list
let guestList1: string[] = ["Shahid", "Zakir", "Ayaz"];

// Print the name of the guest who can't make it
    console.log(guestList1[1] + " can't make it to the dinner.");

// Replace the name of the guest who can't make it with a new person you are inviting
    const newPerson1: string = "Danish";
...
// Add one new guest to the beginning of your array
    const firstGuest1: string = "Asif";
    guestList1.unshift(firstGuest1);

// Add one new guest to the middle of your array
    const middleIndex1: number = Math.floor(guestList2.length / 2);
    const middleGuest1: string = "Hafeez";
    guestList1.splice(middleIndex1, 0, middleGuest1);

// Use push() to add one new guest to the end of your list 
    const lastGuest1: string = "Sagar";
...
let guestList3: string[] = ["Alice", "Bob", "Charlie"];

    // Print the name of the guest who can't make it
    console.log(guestList3[1] + " can't make it to the dinner.");

    // Replace the name of the guest who can't make it with a new person you are inviting
    const newPerson3: string = "David";
...
for (let i = 0; i < guestList3.length; i++) {
    ...
    // Add one new guest to the beginning of your array
    const firstGuest3: string = "Eve";
    guestList3.unshift(firstGuest3);

    // Add one new guest to the middle of your array
    const middleIndex3: number = Math.floor(guestList3.length / 2);
    const middleGuest3: string = "Frank";
    guestList3.splice(middleIndex3, 0, middleGuest3);

    // Use push() to add one new guest to the end of your list 
    const lastGuest3: string = "Grace";
...
while (guestList3.length > 2) {
    const removedName: string | undefined = guestList3.pop();
    if (removedName) {
...
let placesToVisit: string[] = ["UAE", "Canada", "Paris", "Ireland", "Itally"];
...
let guestList4: string[] = ["Shahid", "Zakir", "Ayaz"];

    // Print the name of the guest who can't make it
    console.log(guestList4[1] + " can't make it to the dinner.");

    // Replace the name of the guest who can't make it with a new person you are inviting
    const newPerson4: string = "Danish";
...
let programmingLanguages5: string[] = ["JavaScript", "Python", "Java", "TypeScript", "C++"];
...
let country3 = {
    ...
    // Create an array to store a list of programming languages
let programmingLanguages6: string[] = ["JavaScript", "Python", "Java", "TypeScript", "C++"];
...
if (favoriteFruits.includes('mango')) {
    console.log('You really like mangoes!');
        ...
        // Array of usernames
let usernames1: string[] = ['Yasir', 'Raza', 'Sagar', 'Abbas', 'Shahid'];
...
let current_users: string[] = ['Yasir', 'Sagar', 'admin', 'Abbas', 'Shahid'];

// List of new usernames
let new_users: string[] = ['Raza', 'Hafeez', 'Asif', 'Yasir']; 

// Convert all usernames to lowercase for case-insensitive comparison
let lowerCaseCurrentUsers: string[] = current_users.map(username => username.toLowerCase());
...
// Print the number with its ordinal ending
        console.log(`${num}${ordinal}`); // Print the number with its ordinal ending
            ...
            // ASSIGNMENT #34
let pizzas: string[] = ["pepperoni", "margherita", "supreme"]; // Array of pizza names
...
function show_magicians8(magicians: string[]): void {
    for (let magician of magicians) {
        console.log(magician);
    }
}

let magicians9: string[] = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller"];
...
function make_great9(magicians: string[]): void {
    for (let i = 0; i < magicians.length; i++) {
        magicians[i] = "the Great " + magicians[i];
    }
}

function show_magicians9(magicians: string[]): void {
    for (let magician of magicians) {
        console.log(magician);
    }
}
...
let magicians2: string[] = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller"];
...
function createCar(manufacturer: string, model: string, ...options: CarOptions[]): Car {
